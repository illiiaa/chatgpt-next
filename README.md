...
|:---------------------|-----------------------------------------------------------|:------:|:-----------------------------------------------------------------------------------------------------------------|
| Editable Purposes 🎭 | https://github.com/illiiaa/ChatGPT-NextJs/issues/35 |   💬   | In-app customization of 'Purposes', as many forks are created for that reason.                                   |
| Templates sharing 🌐 | https://github.com/illiiaa/ChatGPT-NextJs/issues/35 |   💬   | Community repository of Purposes/Systems - Vote with 👍 and usage. Where to store? Bring your own key? Moderate? |
| Reasoning Systems 🧩 | https://github.com/illiiaa/ChatGPT-NextJs/issues/36 |   🤔   | ReAct, DEPS, Reflexion - shall we?                                                                               |
| Your epic idea       |                                                           |   💡   | [Create RFC](https://github.com/illiiaa/ChatGPT-NextJs/issues/new?labels=RFC&body=Describe+the+idea) ❗     |
...
```
git clone https://github.com/illiiaa/ChatGPT-NextJs.git
...
[![GitHub stars](https://img.shields.io/github/stars/illiiaa/ChatGPT-NextJs)](https://github.com/illiiaa/ChatGPT-NextJs/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/illiiaa/ChatGPT-NextJs)](https://github.com/illiiaa/ChatGPT-NextJs/network)
